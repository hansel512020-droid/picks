...
export const PREMIER: FilaClub[] = [
  c('mci', 'Manchester City', 'MCI', 90, 91, 87, '#6CABDD', 'Etihad Stadium', 'Mánchester', `
    ...
    Rodri|MED|16|89; Elliot Anderson|MED|18|85; Enzo Fernández|MED|5|86; Phil Foden|DEL|47|85;
    Erling Haaland|DEL|9|91; Omar Marmoush|DEL|7|82; Rayan Cherki|DEL|10|81`),
  ...
  c('che', 'Chelsea', 'CHE', 86, 85, 84, '#034694', 'Stamford Bridge', 'Londres', `
    Emiliano Martínez|POR|1|84; Reece James|DEF|24|81; Levi Colwill|DEF|6|81; Wesley Fofana|DEF|29|79;
    Marc Cucurella|DEF|3|81; Maxence Lacroix|DEF|5|78; Moisés Caicedo|MED|25|86; Morgan Rogers|MED|27|85;
    Cole Palmer|DEL|10|85; Pedro Neto|DEL|7|80; Danny Welbeck|DEL|18|76;
    João Pedro|DEL|20|80; Estêvão|DEL|41|81`),
  c('tot', 'Tottenham Hotspur', 'TOT', 83, 83, 80, '#132257', 'Tottenham Hotspur Stadium', 'Londres', `
    Pedro Porro|DEF|23|79; Cristian Romero|DEF|17|86;
    Micky van de Ven|DEF|37|82; Destiny Udogie|DEF|13|79; Marcos Senesi|DEF|25|79;
    Jan Paul van Hecke|DEF|4|78; Rodrigo Bentancur|MED|30|79; Sandro Tonali|MED|8|83;
    Pape Matar Sarr|MED|29|78; James Maddison|MED|10|81; Dejan Kulusevski|DEL|21|82;
    Mohammed Kudus|DEL|20|83; Dominic Solanke|DEL|19|79; Richarlison|DEL|9|78; Savinho|DEL|26|82`),
  ...
  c('new', 'Newcastle United', 'NEW', 83, 82, 82, '#241F20', "St James' Park", 'Newcastle', `
    ...
    Dan Burn|DEF|33|76; Bruno Guimarães|MED|39|84;
    Joelinton|MED|7|81; Anthony Elanga|DEL|20|78;
    Nick Woltemade|DEL|27|79; Harvey Barnes|DEL|11|77`),
  c('avl', 'Aston Villa', 'AVL', 82, 81, 80, '#95BFE5', 'Villa Park', 'Birmingham', `
    Matty Cash|DEF|2|76; Ezri Konsa|DEF|4|79; Pau Torres|DEF|14|80;
    Lucas Digne|DEF|12|77; Boubacar Kamara|MED|44|80; Youri Tielemans|MED|8|81; João Gomes|MED|27|78;
    Emiliano Buendía|DEL|10|78; Ollie Watkins|DEL|11|81; Nicolas Jackson|DEL|15|80;
    Donyell Malen|DEL|20|78; John McGinn|MED|7|79`),
  c('bha', 'Brighton', 'BHA', 79, 79, 77, '#0057B8', 'Amex Stadium', 'Brighton', `
    Bart Verbruggen|POR|1|81; Joël Veltman|DEF|6|75;
    ...
    Yankuba Minteh|DEL|11|78`),
  c('whu', 'West Ham United', 'WHU', 76, 75, 75, '#7A263A', 'London Stadium', 'Londres', `
    Alphonse Areola|POR|23|76; Max Kilman|DEF|26|77;
    Emerson|DEF|33|74; Tomáš Souček|MED|28|79;
    Guido Rodríguez|MED|24|75; Jarrod Bowen|DEL|20|81;
  ...
  c('cry', 'Crystal Palace', 'CRY', 78, 76, 78, '#1B458F', 'Selhurst Park', 'Londres', `
    ...
    Tyrick Mitchell|DEF|3|75; Adam Wharton|MED|20|80;
  ...
  c('bre', 'Brentford', 'BRE', 76, 76, 74, '#E30613', 'Gtech Community Stadium', 'Londres', `
    ...
    Yoane Wissa|DEL|11|78; Igor Thiago|DEL|9|75; Jaidon Anthony|DEL|20|72`),
  c('ful', 'Fulham', 'FUL', 76, 75, 75, '#000000', 'Craven Cottage', 'Londres', `
    ...
    Alex Iwobi|DEL|17|78; Raúl Jiménez|DEL|7|76;
  ...
  c('eve', 'Everton', 'EVE', 75, 72, 76, '#003399', 'Hill Dickinson Stadium', 'Liverpool', `
    ...
    James Tarkowski|DEF|6|78; Vitalii Mykolenko|DEF|19|75; Aaron Wan-Bissaka|DEF|29|76; Idrissa Gueye|MED|27|77;
  ...
  c('wol', 'Wolverhampton', 'WOL', 73, 72, 72, '#FDB913', 'Molineux', 'Wolverhampton', `
    ...
    Rayan Aït-Nouri|DEF|3|78; André|MED|7|79;
    Hwang Hee-chan|DEL|11|78; Jørgen Strand Larsen|DEL|9|77;
  ...
  c('nfo', 'Nottingham Forest', 'NFO', 77, 75, 78, '#DD0000', 'City Ground', 'Nottingham', `
    ...
    Ola Aina|DEF|43|77; Ryan Yates|MED|22|73;
    Morgan Gibbs-White|MED|10|81; Chris Wood|DEL|11|78;
    Callum Hudson-Odoi|DEL|14|76`),
  c('bou', 'Bournemouth', 'BOU', 77, 76, 76, '#B50E12', 'Vitality Stadium', 'Bournemouth', `
    Đorđe Petrović|POR|1|77; Adam Smith|DEF|15|72;
    Bafodé Diakité|DEF|3|77; Ryan Christie|MED|10|75;
  ...
  c('bur', 'Burnley', 'BUR', 70, 68, 70, '#6C1D45', 'Turf Moor', 'Burnley', `
    Martin Dúbravka|POR|1|74; Connor Roberts|DEF|14|70;
    CJ Egan-Riley|DEF|3|70; Lucas Pires|DEF|22|69; Josh Cullen|MED|24|72;
    Josh Laurent|MED|4|70;
...
export const LALIGA: FilaClub[] = [
  c('rma', 'Real Madrid', 'RMA', 91, 92, 87, '#FEBE10', 'Santiago Bernabéu', 'Madrid', `
    ...
    Franco Mastantuono|DEL|30|80; Gonzalo García|DEL|16|77; Carlos Espí|DEL|19|76`),
  c('fcb', 'FC Barcelona', 'BAR', 90, 92, 85, '#A50044', 'Spotify Camp Nou', 'Barcelona', `
    Joan García|POR|1|82; Jules Koundé|DEF|23|84; Pau Cubarsí|DEF|5|83; João Cancelo|DEF|2|82;
    Alejandro Balde|DEF|3|80; Frenkie de Jong|MED|21|86; Gavi|MED|6|82;
    Pedri|MED|8|88; Dani Olmo|MED|20|84; Lamine Yamal|DEL|10|89;
    Raphinha|DEL|11|86; Gabriel Jesus|DEL|9|82; Anthony Gordon|DEL|17|81`),
  ...
  c('vil', 'Villarreal', 'VIL', 80, 80, 78, '#FFE667', 'Estadio de la Cerámica', 'Villarreal', `
    ...
    Thomas Partey|MED|18|80; Pape Gueye|MED|24|76; Nicolas Pépé|DEL|19|76;
    Ayoze Pérez|DEL|11|79; Georges Mikautadze|DEL|9|78; Alberto Moleiro|DEL|7|78`),
  ...
  c('rbe', 'Real Betis', 'BET', 79, 79, 77, '#00954C', 'Benito Villamarín', 'Sevilla', `
    ...
    Ricardo Rodríguez|DEF|12|74; Fran García|DEF|3|78; Marc Roca|MED|21|77;
    Facundo Bernal|MED|14|75; Isco|MED|22|82; Antony|DEL|7|81;
    Cucho Hernández|DEL|9|77; Troy Parrott|DEL|18|78;
    Pablo Fornals|MED|8|77; Abde Ezzalzouli|DEL|10|78`),
  c('rso', 'Real Sociedad', 'RSO', 78, 76, 78, '#0067B1', 'Reale Arena', 'San Sebastián', `
    Álex Remiro|POR|1|80; Jon Martín|DEF|12|74; Igor Zubeldia|DEF|4|78; Jon Aramburu|DEF|22|74;
    Sergio Gómez|DEF|3|75; Beñat Turrientes|MED|6|78; Carlos Soler|MED|23|78;
  ...
  c('sev', 'Sevilla', 'SEV', 75, 73, 75, '#D40026', 'Ramón Sánchez-Pizjuán', 'Sevilla', `
    Odysseas Vlachodimos|POR|1|78; Fran González|DEF|16|73; Kike Salas|DEF|4|73; Marcão|DEF|22|74;
    Adrià Pedrosa|DEF|3|73; Youssouf Fofana|MED|6|79; Lucien Agoumé|MED|18|75;
    Dodi Lukébakio|DEL|11|78; Isaac Romero|DEL|19|74; Lucas Stassin|DEL|24|74;
  ...
  c('val', 'Valencia', 'VAL', 74, 72, 75, '#F5A300', 'Mestalla', 'Valencia', `
    ...
    César Tárrega|DEF|24|73; José Gayà|DEF|14|76; Arnau Martínez|DEF|20|75; Pepelu|MED|10|75;
    Javi Guerra|MED|8|78; André Almeida|MED|18|74; Harvey Elliott|MED|19|79;
    Diego López|DEL|16|76; Hugo Duro|DEL|9|75; Luis Rioja|DEL|11|73`),
  c('cel', 'Celta de Vigo', 'CEL', 75, 76, 72, '#8AC3EE', 'Balaídos', 'Vigo', `
    Vicente Guaita|POR|1|75; Javi Galán|DEF|2|75; Marcos Alonso|DEF|3|74;
    Carl Starfelt|DEF|4|75; Javi Rueda|DEF|22|72; Fran Beltrán|MED|14|75;
    Ilaix Moriba|MED|5|75; Hugo Álvarez|MED|17|74; Aleix Febas|MED|20|73;
    Borja Iglesias|DEL|9|77; Iago Aspas|DEL|10|79; Pablo Durán|DEL|19|73`),
  c('rvo', 'Rayo Vallecano', 'RAY', 73, 70, 74, '#E53027', 'Estadio de Vallecas', 'Madrid', `
    ...
    Marash Kumbulla|DEF|22|74; Óscar Valentín|MED|20|74;
  ...
  c('gir', 'Girona', 'GIR', 74, 73, 72, '#CD2534', 'Montilivi', 'Girona', `
    Paulo Gazzaniga|POR|13|76; Daley Blind|DEF|17|75;
  ...
  c('mll', 'Mallorca', 'MLL', 73, 70, 75, '#E20613', 'Son Moix', 'Palma', `
    Arnau Tenas|POR|13|74; Alberto Moreno|DEF|2|73; Martin Valjent|DEF|4|75;
    Antonio Raíllo|DEF|5|74; Toni Lato|DEF|3|72; Sergi Darder|MED|23|77;
    Samú Costa|MED|6|75; Manu Morlanes|MED|8|73; Zito Luvumbo|DEL|7|74;
    Cyle Larin|DEL|9|74; Takuma Asano|DEL|22|73`),
  c('get', 'Getafe', 'GET', 71, 68, 73, '#005999', 'Coliseum', 'Madrid', `
    David Soria|POR|1|75; Juan Iglesias|DEF|18|73; Djené|DEF|2|75; Diego Rico|DEF|3|72; Johan Mojica|DEF|14|73; Ramón Terrats|MED|8|74;
    Mario Martín|MED|21|71; Christantus Uche|MED|20|74; Álex Sancris|DEL|11|71;
    Borja Mayoral|DEL|7|76; Enes Ünal|DEL|9|76; Martín Satriano|DEL|29|75;
  ...
  c('ala', 'Deportivo Alavés', 'ALA', 71, 69, 72, '#0761AF', 'Mendizorroza', 'Vitoria', `
    ...
    Santiago Mouriño|DEF|22|73; Manu Sánchez|DEF|3|71; Nicolás Valentini|DEF|15|75; Antonio Blanco|MED|6|74;
  ...
  c('esp', 'RCD Espanyol', 'ESP', 71, 69, 72, '#007FC8', 'RCDE Stadium', 'Barcelona', `
    ...
    Unai Núñez|DEF|4|75; Quilindschy Hartman|DEF|3|74; Edu Expósito|MED|8|75;
    Pol Lozano|MED|6|72; Gabriel Moscardo|MED|20|74; Javi Puado|DEL|10|76;
    Pere Milla|DEL|11|72; Roberto Fernández|DEL|9|72; Kike García|DEL|19|72`),
  c('elc', 'Elche', 'ELC', 69, 67, 70, '#00913F', 'Martínez Valero', 'Elche', `
    ...
    Álvaro Núñez|DEF|3|70; Marc Aguado|MED|6|71;
  ...
  c('lev', 'Levante', 'LEV', 68, 67, 68, '#004C9F', 'Ciutat de València', 'Valencia', `
    ...
    Matías Moreno|DEF|22|69; Jeremy Toljan|DEF|2|71; Aïssa Mandi|DEF|5|75; Carlos Álvarez|MED|10|74;
  ...
  c('ovi', 'Real Oviedo', 'OVI', 67, 65, 68, '#004B9F', 'Carlos Tartiere', 'Oviedo', `
    ...
    Dani Calvo|DEF|4|69; Dani Villahermosa|MED|3|71;
    Ilyas Chaira|MED|11|70; Álex Forés|DEL|9|69; Estanislau Pedrola|DEL|7|72;
    Josip Brekalo|DEL|10|73; Federico Viñas|DEL|19|70; Carlos Fernández|DEL|17|75`),
];
...
export const SERIEA: FilaClub[] = [
  ...
  c('juv', 'Juventus', 'JUV', 84, 82, 84, '#000000', 'Allianz Stadium', 'Turín', `
    Guglielmo Vicario|POR|1|82; Pierre Kalulu|DEF|15|78; Gleison Bremer|DEF|3|84;
  ...
  c('mil', 'AC Milan', 'MIL', 84, 83, 83, '#FB090B', 'San Siro', 'Milán', `
    ...
    Strahinja Pavlović|DEF|31|79; Theo Hernández|DEF|19|82; Luka Modrić|MED|14|84; Christian Pulisic|DEL|11|84; Rafael Leão|DEL|10|84;
  ...
  c('laz', 'Lazio', 'LAZ', 79, 78, 78, '#87D8F7', 'Stadio Olimpico', 'Roma', `
    ...
    Valentín Castellanos|DEL|11|77`),
  ...
  c('tor', 'Torino', 'TOR', 74, 71, 76, '#8A1E03', 'Grande Torino', 'Turín', `
    ...
    Valentino Lazaro|DEF|20|74; Samuele Ricci|MED|28|78;
  ...
  c('com', 'Como', 'COM', 76, 75, 74, '#004B9F', 'Giuseppe Sinigaglia', 'Como', `
    Jean Butez|POR|1|74; Alberto Dossena|DEF|4|74;
  ...
  c('cag', 'Cagliari', 'CAG', 70, 68, 71, '#B4053A', 'Unipol Domus', 'Cagliari', `
    ...
    Matteo Prati|MED|6|72; Nicolás Viola|MED|10|72; Roberto Piccoli|DEL|91|75; Sebastiano Esposito|DEL|94|74`),
  ...
  c('ver', 'Hellas Verona', 'VER', 67, 65, 68, '#F8D51C', 'Marcantonio Bentegodi', 'Verona', `
    ...
    Victor Nelsson|DEF|5|72; Suat Serdar|MED|8|73;
...
export const BUNDESLIGA: FilaClub[] = [
  c('bay', 'Bayern de Múnich', 'BAY', 91, 93, 87, '#DC052D', 'Allianz Arena', 'Múnich', `
    ...
    Aleksandar Pavlović|MED|45|80; Michael Olise|DEL|17|85;
    Harry Kane|DEL|9|89; Luis Díaz|DEL|14|87; Serge Gnabry|DEL|7|81;
    Jamal Musiala|MED|10|88; Nathaniel Brown|DEF|18|75`),
  ...
  c('bvb', 'Borussia Dortmund', 'BVB', 84, 83, 82, '#FDE100', 'Signal Iduna Park', 'Dortmund', `
    ...
    Serhou Guirassy|DEL|9|83; Maximilian Beier|DEL|14|78; Ethan Nwaneri|MED|24|78`),
  c('rbl', 'RB Leipzig', 'RBL', 82, 81, 81, '#DD0741', 'Red Bull Arena', 'Leipzig', `
    Péter Gulácsi|POR|1|79; Willi Orbán|DEF|4|79;
  ...
  c('sge', 'Eintracht Fráncfort', 'SGE', 80, 81, 77, '#E1000F', 'Deutsche Bank Park', 'Fráncfort', `
    ...
    Arthur Theate|DEF|5|76; Ellyes Skhiri|MED|15|77;
  ...
  c('vfl', 'VfL Wolfsburgo', 'WOB', 74, 73, 74, '#65B32E', 'Volkswagen Arena', 'Wolfsburgo', `
    ...
    Saël Kumbedi|DEF|4|74; Mattias Svanberg|MED|8|75;
    Aster Vranckx|MED|27|74; Yannick Gerhardt|MED|31|73; Fabian Reese|DEL|11|75;
    Mohammed Amoura|DEL|9|77`),
  c('fcu', 'Union Berlín', 'FCU', 71, 68, 73, '#EB1923', 'An der Alten Försterei', 'Berlín', `
    Frederik Rønnow|POR|1|76; Christopher Trimmel|DEF|28|72; Juma Bah|DEF|4|72;
    Tom Rothe|DEF|3|73; Rani Khedira|MED|21|74;
    János Kovács|MED|8|71; Andrej Ilić|DEL|9|73;
  ...
  c('scf', 'SC Friburgo', 'SCF', 76, 74, 76, '#000000', 'Europa-Park Stadion', 'Friburgo', `
    ...
    Lucas Höler|DEL|9|73; Junior Adamu|DEL|17|73; Philipp Treu|DEF|20|70`),
  c('m05', 'Mainz 05', 'M05', 73, 71, 74, '#C3141E', 'Mewa Arena', 'Maguncia', `
    ...
    Armindo Sieb|DEL|20|74; Nelson Weiper|DEL|29|73; Eric Martel|MED|8|72; Phillip Tietz|DEL|11|72`),
  c('bmg', 'Borussia Mönchengladbach', 'BMG', 73, 72, 72, '#000000', 'Borussia-Park', 'Mönchengladbach', `
    ...
    Tim Kleindienst|DEL|45|77; Isac Lidberg|DEL|9|74`),
  ...
  c('fca', 'FC Augsburgo', 'FCA', 70, 68, 71, '#BA3733', 'WWK Arena', 'Augsburgo', `
    ...
    Chrislain Matsima|DEF|4|72; Robin Gosens|DEF|21|78;
    Arne Maier|MED|10|73; Kristijan Jakić|MED|4|73; Alexis Claude-Maurice|DEL|11|74;
    Samuel Essende|DEL|9|72`),
  c('sca', 'FC St. Pauli', 'STP', 67, 64, 69, '#614F45', 'Millerntor-Stadion', 'Hamburgo', `
    Hauke Wahl|DEF|4|71; Carlo Boukhalfa|MED|6|70; Andréas Hountondji|DEL|9|70;
    Morgan Guilavogui|DEL|11|70; Danel Sinani|MED|10|71`),
  c('hei', 'FC Heidenheim', 'HDH', 66, 64, 67, '#E30613', 'Voith-Arena', 'Heidenheim', `
    Marnon Busch|DEF|22|69; Patrick Mainka|DEF|6|70;
    Benedikt Gimber|DEF|32|69; Oualid Mhamdi|DEF|5|68; Jan Schöppner|MED|20|70;
    Adrian Beck|MED|8|69; Mathias Honsak|DEL|27|70;
  ...
  c('hsv', 'Hamburgo SV', 'HSV', 69, 67, 70, '#0A5CA8', 'Volksparkstadion', 'Hamburgo', `
    ...
    Dennis Hadžikadunić|DEF|5|70; Miro Muheim|DEF|17|71; Sebastiaan Bornauw|DEF|3|74; Jonas Meffert|MED|8|72;
    Nicolás Capaldo|MED|5|73; Fábio Vieira|MED|10|76; Ransford Königsdörffer|DEL|7|71;
    Robert Glatzel|DEL|9|73; Davie Selke|DEL|27|72; Terem Moffi|DEL|19|75`),
  c('koe', '1. FC Colonia', 'KOE', 68, 67, 68, '#ED1C24', 'RheinEnergieStadion', 'Colonia', `
    ...
    Dominique Heintz|DEF|3|69; Leart Paqarada|DEF|22|70;
...
export const LIGUE1: FilaClub[] = [
  c('psg', 'Paris Saint-Germain', 'PSG', 90, 91, 87, '#004170', 'Parc des Princes', 'París', `
    ...
    João Neves|MED|87|84; Fabián Ruiz|MED|8|83; Maghnes Akliouche|MED|11|82; Ousmane Dembélé|DEL|10|87;
    Ferran Torres|DEL|29|84; Désiré Doué|DEL|14|82; Khvicha Kvaratskhelia|DEL|7|85`),
  c('mar', 'Olympique de Marsella', 'OM', 82, 82, 80, '#2FAEE0', 'Orange Vélodrome', 'Marsella', `
    Jeffrey de Lange|POR|30|74; Amir Murillo|DEF|24|75; Leonardo Balerdi|DEF|5|79;
    CJ Egan-Riley|DEF|3|71; Facundo Medina|DEF|12|77; Arkadiusz Milik|DEL|19|76;
    Geoffrey Kondogbia|MED|8|78; Adrien Rabiot|MED|25|83; Timothy Weah|DEL|21|78;
    Amine Gouiri|DEL|9|78; Igor Paixão|DEL|11|79`),
  c('mon', 'AS Mónaco', 'MON', 80, 80, 78, '#CE242D', 'Stade Louis II', 'Mónaco', `
    ...
    Mohammed Salisu|DEF|17|76; Sadibou Sané|DEF|5|72; Denis Zakaria|MED|20|80;
    Lamine Camara|MED|6|76; Takumi Minamino|DEL|18|76; Matthis Abline|DEL|11|76;
  ...
  c('lil', 'Lille OSC', 'LIL', 78, 77, 78, '#E01E13', 'Stade Pierre-Mauroy', 'Lille', `
    Berke Özer|POR|30|76; Thomas Meunier|DEF|24|74; Alexsandro|DEF|5|77; Romain Perraud|DEF|3|74; Tanguy Nianzou|DEF|4|75; Benjamin André|MED|21|76;
    Ngal'ayel Mukau|MED|8|75; Hamza Igamane|DEL|9|75;
    Olivier Giroud|DEL|17|76; Ayase Ueda|DEL|11|76`),
  c('lyo', 'Olympique de Lyon', 'OL', 78, 77, 77, '#E4022E', 'Groupama Stadium', 'Lyon', `
    ...
    Tanner Tessmann|MED|32|74; Pavel Šulc|MED|20|77; Mads Bidstrup|MED|6|75;
    Julien Duranville|DEL|11|76; Noham Kamara|DEL|9|73`),
  c('nic', 'OGC Niza', 'NIC', 75, 74, 75, '#E30613', 'Allianz Riviera', 'Niza', `
    Yehvann Diouf|POR|1|74; Jonathan Clauss|DEF|7|77; Dante|DEF|31|74;
    Niels Nkounkou|DEF|22|73; Antoine Mendy|DEF|2|72; Morgan Sanson|MED|8|74;
    Hicham Boudaoui|MED|6|74; Sofiane Diop|DEL|10|76;
    Gauthier Hein|DEL|9|72; Nathan Ngoumou|DEL|18|73; Kevin Carlos|DEL|11|73`),
  c('ren', 'Stade Rennais', 'REN', 76, 76, 74, '#E23B33', 'Roazhon Park', 'Rennes', `
    Brice Samba|POR|30|78; Anthony Rouault|DEF|4|74; Charlie Cresswell|DEF|5|73;
    ...
    Eliezer Mayenda|DEL|36|76; Boulaye Dia|DEL|19|78; Issa Soumaré|DEL|7|69; Mahdi Camara|MED|6|73`),
  c('str', 'RC Estrasburgo', 'STR', 75, 76, 72, '#009FE3', 'Stade de la Meinau', 'Estrasburgo', `
    Mike Penders|POR|1|74; Jeyland Mitchell|DEF|2|72; Ismaël Doukouré|DEF|4|74;
    Mamadou Sarr|DEF|5|74; Marvin Barnes-Homer|DEF|3|71; Habib Diarra|MED|6|77;
    Andrey Santos|MED|8|78; Dilane Bakwa|DEL|11|77; Giovanni Reyna|DEL|9|76;
    Joaquín Panichelli|DEL|19|75; Karim Coulibaly|DEL|18|75; Félix Lemaréchal|MED|10|74`),
  c('len', 'RC Lens', 'LEN', 75, 73, 76, '#FFE500', 'Stade Bollaert-Delelis', 'Lens', `
    Robin Risser|POR|1|73; Jonathan Gradit|DEF|24|75; Jean-Clair Todibo|DEF|22|78;
    Maik Nawrocki|DEF|3|75; Deiver Machado|DEF|12|74; Michaël Cuisance|MED|20|74;
    Neil El Aynaoui|MED|8|75; Florian Sotoca|DEL|7|76;
  ...
  c('tou', 'Toulouse FC', 'TFC', 71, 70, 71, '#5F259F', 'Stadium de Toulouse', 'Toulouse', `
    Guillaume Restes|POR|1|76; Rasmus Nicolaisen|DEF|4|72;
  ...
  c('nan', 'FC Nantes', 'NAN', 68, 65, 70, '#FFE500', 'Stade de la Beaujoire', 'Nantes', `
    ...
    Douglas Augusto|MED|8|72;
    Johann Lepenant|MED|6|72; Mostafa Mohamed|DEL|9|73;
    Thomas Robinet|DEL|10|69; Louis Leroux|MED|20|70`),
  c('aux', 'AJ Auxerre', 'AUX', 67, 65, 68, '#0067B1', 'Stade Abbé-Deschamps', 'Auxerre', `
    Mamadou Diop|POR|30|69; Christ Makosso|DEF|29|70; Jubal|DEF|4|70;
    Clément Akpa|DEF|5|69; Gaëtan Perrin|MED|10|72; Arthur Piedfort|MED|6|71;
    Rayan Raveloson|MED|8|71; Lasso Coulibaly|MED|18|69; Danny Namaso|DEL|11|72;
  ...
  c('ang', 'Angers SCO', 'ANG', 66, 63, 68, '#000000', 'Stade Raymond Kopa', 'Angers', `
    ...
    Marouan Fakhreddine|MED|6|69; Yann Kitala|DEL|19|69;
  ...
  c('mtp', 'Montpellier HSC', 'MHSC', 66, 64, 67, '#0B2A6B', 'Stade de la Mosson', 'Montpellier', `
    ...
    Kiki Kouyaté|DEF|4|70; Joris Chotard|MED|8|72;
  ...
  c('hav', 'Le Havre AC', 'HAC', 65, 62, 67, '#0B2A6B', 'Stade Océane', 'Le Havre', `
    Antoine Joujou|MED|8|68; Rassoul Ndiaye|MED|6|69;
    Josué Casimir|DEL|11|69; Ayumu Seko|DEF|3|70;
    Simon Ebonog|DEL|9|68`),
  c('mez', 'FC Metz', 'MET', 64, 62, 65, '#8A0F1E', 'Stade Saint-Symphorien', 'Metz', `
    ...
    Fali Candé|DEF|3|68; Joseph N'Duquidi|MED|6|68;
    Cheikh Sabaly|DEL|7|69;
    Boubacar Traoré|MED|18|70`),
...
export const OTROS_EUROPA: FilaClub[] = [
  c('spo', 'Sporting CP', 'SCP', 82, 82, 80, '#008057', 'José Alvalade', 'Lisboa', `
    ...
    Zeno Debast|DEF|4|76; Nuno Santos|DEF|8|76;
    Hidemasa Morita|MED|5|77; Pedro Gonçalves|DEL|28|80;
    Luis Suárez|DEL|9|77`),
  c('ben', 'Benfica', 'SLB', 82, 81, 81, '#E30613', 'Estádio da Luz', 'Lisboa', `
    ...
    Alexander Bah|DEF|34|76; Florentino Luís|MED|61|78;
  ...
  c('fcp', 'FC Oporto', 'FCP', 81, 80, 80, '#00428C', 'Estádio do Dragão', 'Oporto', `
    ...
    Samu Aghehowa|DEL|9|79; Gabri Veiga|MED|8|78; Jakub Kiwior|DEF|15|78;
    Hwang In-beom|MED|29|77; Victor Froholdt|MED|6|77`),
  c('bra', 'SC Braga', 'SCB', 76, 75, 75, '#E30613', 'Estádio Municipal', 'Braga', `
    ...
    Roger Fernandes|DEL|17|74; Gabri Martínez|DEL|11|73; Jonas Wind|DEL|29|77`),
  c('aja', 'Ajax', 'AJA', 78, 78, 76, '#D2122E', 'Johan Cruijff ArenA', 'Ámsterdam', `
    ...
    Josip Šutalo|DEF|6|76; Owen Wijndal|DEF|17|74;
  ...
  c('psv', 'PSV Eindhoven', 'PSV', 81, 82, 78, '#EE1C25', 'Philips Stadion', 'Eindhoven', `
    ...
    Yarek Gasiorowski|DEF|5|74;
    Jerdy Schouten|MED|6|79; Guus Til|MED|8|77; Ivan Perišić|DEL|14|79;
    Ricardo Pepi|DEL|9|75; Dennis Man|DEL|7|77; Lutsharel Geertruida|DEF|3|80;
    Sven Mijnans|MED|10|77`),
  c('fey', 'Feyenoord', 'FEY', 77, 77, 75, '#E30613', 'De Kuip', 'Róterdam', `
    ...
    Antoni Milambo|MED|8|76; Igor Paixão|DEL|11|79;
    Anis Hadj Moussa|DEL|7|75; Casper Tengstedt|DEL|19|76`),
  ...
  c('fen', 'Fenerbahçe', 'FEN', 79, 79, 77, '#FFED00', 'Şükrü Saracoğlu', 'Estambul', `
    ...
    Youssef En-Nesyri|DEL|9|78; Anderson Talisca|DEL|11|77; Marco Asensio|DEL|20|82`),
  c('cel2', 'Celtic', 'CEL', 76, 77, 74, '#008C45', 'Celtic Park', 'Glasgow', `
    ...
    Reo Hatate|MED|41|76; Nicolas Kühn|DEL|18|76;
    Daizen Maeda|DEL|38|76; Adam Idah|DEL|9|73; Kasper Høgh|DEL|20|77`),
  c('ran', 'Rangers', 'RAN', 74, 74, 73, '#0B2A6B', 'Ibrox Stadium', 'Glasgow', `
    John Souttar|DEF|4|74;
    Leon Balogun|DEF|5|72; Ridvan Yılmaz|DEF|3|73; Nicolas Raskin|MED|43|75;
    Vaclav Cerny|DEL|11|74; Cyriel Dessers|DEL|9|72;
    Hamza Igamane|DEL|17|75; Ianis Hagi|MED|10|74; Ivor Pandur|POR|1|75;
    Vanja Dragojevic|MED|18|74; Lawrence Shankland|DEL|20|76`),
  c('rbs', 'Red Bull Salzburgo', 'RBS', 74, 74, 72, '#E30613', 'Red Bull Arena', 'Salzburgo', `
    ...
    Hendry Blank|DEF|5|74; Joane Gadou|DEF|3|72;
    Maurits Kjærgaard|MED|10|76; Petar Ratkov|DEL|9|74; Karim Konaté|DEL|11|75;
    Dorgeles Nene|DEL|7|75; Bobby Clark|MED|8|74; Haris Tabaković|DEL|19|76`),
  ...
  c('ola', 'Olympiacos', 'OLY', 75, 74, 74, '#E30613', 'Karaiskakis', 'El Pireo', `
    Konstantinos Tzolakis|POR|1|74; Panagiotis Retsos|DEF|3|74;
    David Carmo|DEF|4|74; Santiago Hezze|MED|5|74;
    Chiquinho|MED|8|75; Daniel Podence|DEL|10|76; Gelson Martins|DEL|7|75;
    Ayoub El Kaabi|DEL|9|76; Rodrigo Costa|DEL|11|73; Manolis Saliakas|DEF|2|75;
    Joel Roca|DEL|12|75`),
  ...
  c('cop', 'FC Copenhague', 'FCK', 71, 70, 71, '#0B2A6B', 'Parken', 'Copenhague', `
    ...
    Jordan Larsson|DEL|10|73; Viktor Dadason|DEL|19|69; Youssoufa Moukoko|DEL|29|76`),
